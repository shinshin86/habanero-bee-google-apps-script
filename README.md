...
* copyrightLink
  * Enter the URL of the website you want to go to when you click on the copyright notice. If not specified, the page of `Habanero Bee` will be set. Also, if you set only `copyrightText`, it will be just text.
